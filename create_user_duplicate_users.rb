...
try_new_admin_response = HTTParty.post(create_new_user_path, headers: {'Authorization': "Bearer #{session_token}"}, body: {firstName: 'Tina', lastName: 'Heiligers', email: 'tina.heiligers@tallwave.com', title: 'Developer', companyId: "#{random_companyId}", isAdmin: true})
